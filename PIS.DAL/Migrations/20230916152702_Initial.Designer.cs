...
namespace PIS.DAL.Migrations
{
    ...
    [Migration("20230916152702_Initial")]
            ...
            modelBuilder.Entity("PIS.Models.Class", b =>
                {
                    ...
                    b.Property<DateTime>("LastModified")
                        ...
                        .HasDefaultValue(new DateTime(2023, 9, 16, 18, 27, 0, 244, DateTimeKind.Local).AddTicks(9105));

                    b.Property<DateTime?>("audDateLastChanged")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 9, 16, 18, 27, 0, 244, DateTimeKind.Local).AddTicks(8694));
            ...
            modelBuilder.Entity("PIS.Models.Schedule", b =>
                {
                    ...
                    b.Property<DateTime?>("audDateLastChanged")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 9, 16, 18, 27, 0, 245, DateTimeKind.Local).AddTicks(1363));
            ...
            modelBuilder.Entity("PIS.Models.station", b =>
                {
                    ...
                    b.Property<DateTime>("LastModified")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 9, 16, 18, 27, 0, 247, DateTimeKind.Local).AddTicks(2677));
                    ...
                    b.Property<DateTime?>("audDateLastChanged")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 9, 16, 18, 27, 0, 247, DateTimeKind.Local).AddTicks(2327));
            ...
            modelBuilder.Entity("PIS.Models.Train_Delay_Reson", b =>
                {
                    ...
                    b.Property<DateTime?>("LastModified")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 9, 16, 18, 27, 0, 247, DateTimeKind.Local).AddTicks(4341));
                    ...
                    b.Property<DateTime?>("audDateLastChanged")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 9, 16, 18, 27, 0, 247, DateTimeKind.Local).AddTicks(4068));
            ...
            modelBuilder.Entity("PIS.Models.Train_Status", b =>
                {
                    ...
                    b.Property<DateTime>("LastModified")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 9, 16, 18, 27, 0, 247, DateTimeKind.Local).AddTicks(5747));
                    ...
                    b.Property<DateTime?>("audDateLastChanged")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 9, 16, 18, 27, 0, 247, DateTimeKind.Local).AddTicks(5466));
            ...
            modelBuilder.Entity("PIS.Models.Train_Trip", b =>
                {
                    ...
                    b.Property<DateTime>("LastModified")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 9, 16, 18, 27, 0, 248, DateTimeKind.Local).AddTicks(4903));
                    ...
                    b.Property<DateTime?>("audDateLastChanged")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 9, 16, 18, 27, 0, 248, DateTimeKind.Local).AddTicks(2630));
            ...
            modelBuilder.Entity("PIS.Models.Train_Type", b =>
                {
                    ...
                    b.Property<DateTime?>("LastModified")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 9, 16, 18, 27, 0, 252, DateTimeKind.Local).AddTicks(4430));
                    ...
                    b.Property<DateTime?>("audDateLastChanged")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 9, 16, 18, 27, 0, 252, DateTimeKind.Local).AddTicks(4116));
            ...
            modelBuilder.Entity("PIS.Models.TrainTripRout", b =>
                {
                    ...
                    b.Property<DateTime>("LastModified")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 9, 16, 18, 27, 0, 252, DateTimeKind.Local).AddTicks(6742));
                    ...
                    b.Property<string>("StationCode1")
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("Train_TripTrainNo")
                        .HasColumnType("nvarchar(450)");

                    b.Property<DateTime?>("audDateLastChanged")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 9, 16, 18, 27, 0, 252, DateTimeKind.Local).AddTicks(6441));

                    b.HasKey("TrainNo", "StationCode")
                        .HasName("PK_TrainTripRout");

                    b.HasIndex("StationCode1");

                    b.HasIndex("Train_TripTrainNo");
            ...
            modelBuilder.Entity("PIS.Models.TrainTripRout", b =>
                {
                    b.HasOne("PIS.Models.station", "Station")
                        ...
                        .HasForeignKey("StationCode1");

                    b.HasOne("PIS.Models.Train_Trip", "Train_Trip")
                        .WithMany("TrainTripRouts")
                        .HasForeignKey("Train_TripTrainNo");
