...
namespace PIS.DTO
{
    ...
    {
        public TrainDisplayInfoViewModel()
        {
            TrainDisplayInfoDetails = new List<TrainDisplayInfoDetailsViewModel>();
        }
        public List<TrainDisplayInfoDetailsViewModel> TrainDisplayInfoDetails { get; set; }
